...
// Sesuai dengan struktur tabel chat Anda: id_penerima, status_baca
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="welcome-card">
            <div class="welcome-text">
                <h2 class="welcome-title">Selamat datang di Wesley Bookstore!</h2>
                <p class="welcome-subtitle">Halo <?php echo htmlspecialchars($username); ?>! Temukan buku impian Anda di toko kami.</p>
            </div>
